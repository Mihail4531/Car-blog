...
<div class="max-w-[1400px] ml-auto mr-auto">
    ...
    <div class="max-w-sm bg-purple-700 border border-purple-700 rounded-lg shadow-sm mt-30 ">
        ...
        <div class="p-5">
            ...
            <p class="mb-3 font-normal text-white ">{{ Str::limit($article->small_text, 17, '...') }}</p>
